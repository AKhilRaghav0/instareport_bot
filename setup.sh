...
echo -e "$Purple Created By \e[1;34m"
       figlet Insta Report | akhilraghav0
sleep 2.0
    echo -e " \e[96m  
                                     ████████ \e[0m"
echo "                                 ████████████████
...
echo -e    "\e[91m"  
echo " "  
figlet -f Bloody Insta-Hack | akhilraghav018

    echo " "
    echo -e "$Red                                 ⫸ Coded by$Yellow Akhil$Red ⫷\033[0m"
    echo -e "$Red                               ⫸$Purple akhilraghav.rocks$Red ⫷\033[0m"
echo " "
echo -e " $Green     |---------------------------------------------------------------------------------|"
